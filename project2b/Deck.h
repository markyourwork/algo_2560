...
//destructor to destroy pointers and prevent memory leak
Deck::~Deck()
{
...
//shuffle the deck by moving the top card randomly around 10000 times
void Deck::shuffle()
{
...
//returns a card at a given spot in a deck
...
//card node to make deck of cards
Node <Card>* Deck::deal()
{	
	Node <Card>* curr;
	curr = topN;
...
//output operator overwritten to display the deck
